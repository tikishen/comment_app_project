...
The content of the comment list can be persisted in a manner similar to the persistence of the username, so that the comments posted by the users can still exist after the page is refreshed. Modify `MyCommentApp.js`:
```
